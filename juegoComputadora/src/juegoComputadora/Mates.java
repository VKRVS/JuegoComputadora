...
public class Mates extends Pregunta {
	...
	public static ArrayList generaOperac(ArrayList nums) {
	...
	// y
	// operaciones
	public static String preguntaCompleta(ArrayList<Integer> nums, ArrayList<String> operac) {
		System.out.println("Tamaño nums: " + nums.size() + "\nTamaño operac: " + operac.size());
	...
	public static void preguntaCompletaNum(ArrayList<Integer> nums, ArrayList<String> operac) {
		int resultado = 0;
	...
	public static boolean comprueba(int introducido, int correcto) {
